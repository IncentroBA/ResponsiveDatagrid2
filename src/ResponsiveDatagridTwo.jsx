    ...
    useEffect(() => {
        function setGridColumns() {
            ...
            const maxColumnArray = columnArray.slice(
                0,
                columnArray.length - (columnArray.length - visibleColumns) + (keepLastBoolean ? -1 : 0)
            );
            ...
            if (!row.querySelector(".th.chevron-th")) {
                const selectTH =
                    RenderChevron === "left"
                        ...
                        : row.querySelector(`.th:nth-child(${visibleColumns + 1})`);
            ...
            if (!row.querySelector(".td.chevron-td")) {
                const selectTD =
                    RenderChevron === "left"
                        ...
                        : row.querySelector(`.td:nth-child(${visibleColumns + 1})`);
